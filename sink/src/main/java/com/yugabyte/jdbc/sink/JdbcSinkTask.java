  ...
  private static final Logger log = LoggerFactory.getLogger(JdbcSinkTask.class);
    ...
    public void start(final Map<String, String> props) {
      ...
      try {
        ...
        log.error("PostgreSQL JDBC Driver not found in class path", e);
        throw new ConnectException("PostgreSQL JDBC Driver not found", e);
      }
    ...
    void initWriter() {
      ...
      if (dialect == null) {
        log.error("Failed to initialize the PostgreSQL database dialect.");
        throw new ConnectException("Database dialect initialization failed.");
      }
